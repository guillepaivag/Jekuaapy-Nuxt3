<template>
    <div class="h-full fondo w-full py-16 px-4">
        <!--- more free and premium Tailwind CSS components at https://tailwinduikit.com/ --->

        <div class="flex flex-col items-center justify-center">
            <div class="bg-white shadow rounded lg:w-1/3  md:w-1/2 w-full p-10 ">
                <p tabindex="0" class="focus:outline-none text-2xl font-extrabold leading-6 text-gray-800">Inicia sesión
                </p>
                <p tabindex="0" class="focus:outline-none text-sm mt-4 font-medium leading-none text-gray-500">¿No
                    tienes una cuenta?
                ...
                <button aria-label="Continuar con google" role="button"
                    ...
                    <p class="text-base font-medium ml-4 text-gray-700">Continuar con Google</p>
                </button>
                <button aria-label="Continuar con twitter" role="button"
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.0"
                        x="0px" y="0px" width="19" height="20" viewBox="0 0 50 50" style="null"
                    ...
                    <p class="text-base font-medium ml-4 text-gray-700">Continuar con Facebook</p>
                </button>
                ...
                <div>
                    ...
                    <input aria-labelledby="email" type="email" v-model="email"
                ...
                <div class="mt-8">
                    <button role="button" @click="login()"
                        class="focus:ring-2 focus:ring-offset-2 focus:ring-indigo-700 text-sm font-semibold leading-none text-white focus:outline-none bg-indigo-700 border rounded hover:bg-indigo-600 py-4 w-full">Iniciar
                        Sesión</button>
                </div>
            </div>
        </div>
