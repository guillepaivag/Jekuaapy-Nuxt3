        ...
        <div class="mx-auto container px-6 py-2 xl:py-0">
            <div class="flex items-center justify-between">
                            ...
                            <ul class="p-2 border-r bg-white absolute rounded left-0 right-0 shadow mt-8 md:mt-8 hidden">
                                ...
                                <li v-if="!user"
                                    ...
                                    <NuxtLink :to="'/registro'"
                                        ...
                                        <span
                                            class="text-lila group-hover:text-white relative px-5 py-1.5 transition-all ease-in duration-75 bg-white dark:bg-gray-900 rounded-md group-hover:bg-opacity-0">
                                            Registrarse
                                        </span>
                                    </NuxtLink>
                                </li>
                ...
                <div class="flex">
                    ...
                    <div class="hidden xl:flex items-center" v-if="user">
                    ...
                    <div class="hidden xl:flex items-center mt-2" v-else>
                        ...
                        <NuxtLink :to="'/registro'"
                            ...
                            <span
                                class="text-lila group-hover:text-white relative px-5 py-2.5 transition-all ease-in duration-75 bg-white dark:bg-gray-900 rounded-md group-hover:bg-opacity-0">
                                Registrarse
                            </span>
                        </NuxtLink>
                    </div>
